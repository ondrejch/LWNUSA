...
3 1 -18.90 2 -3 imp:n,p=1 u=1         \$ uranium fuel
4 6 -2.70 3 -4 imp:n,p=1 u=1          \$ outer aluminum cladding
5 4 -0.998207 4 -5 imp:n,p=1 u=1      \$ water outside fuel slug
6 6 -2.70 5 -6 imp:n,p=1 u=1          \$ aluminum tube of fuel rod
7 4 -0.998207 6 -9 imp:n,p=1 u=1      \$ water outside of fuel rod
8 0 -7 lat=1 fill=1 u=2 imp:n,p=1     \$ fill fuel rods into lattice
9 0 -8 fill=2 imp:n,p=1               \$ fill lattice into real world
